...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item active">
      ...
      <a class="nav-link" href="{{route('home1')}}">accueil <span class="sr-only"></span></a>
    </li>

    @auth
      <li class="nav-item">
        <a class="nav-link" href="{{route('mine')}}">mes articles</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="/home">Dasbord</a>
      </li>
      <li class="nav-item">
...
@endauth
    ...
    <footer class="text-center text-white m-0 p-0" style="background-color: #f1f1f1;">
  <!-- Grid container -->
  ...
  <div class="text-center text-dark p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2022 Copyright:
    <a class="text-dark" href="https://mdbootstrap.com/">adrien-school</a>
  </div>
  <!-- Copyright -->
</footer>
</body>
